...
enum opt_code
{
  ...
  OPT_mvectorize_with_neon_quad = 981,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 982,               /* -mword-relocations */
  OPT_mwords_little_endian = 983,            /* -mwords-little-endian */
  OPT_n = 984,                               /* -n */
  OPT_no_canonical_prefixes = 985,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 986,               /* -no-integrated-cpp */
  OPT_nocpp = 987,                           /* -nocpp */
  OPT_nodefaultlibs = 988,                   /* -nodefaultlibs */
  OPT_nostartfiles = 989,                    /* -nostartfiles */
  OPT_nostdinc = 990,                        /* -nostdinc */
  OPT_nostdinc__ = 991,                      /* -nostdinc++ */
  OPT_nostdlib = 992,                        /* -nostdlib */
  OPT_o = 993,                               /* -o */
  OPT_p = 994,                               /* -p */
  OPT_pass_exit_codes = 995,                 /* -pass-exit-codes */
  OPT_pedantic = 996,                        /* -pedantic */
  OPT_pedantic_errors = 997,                 /* -pedantic-errors */
  OPT_pg = 998,                              /* -pg */
  OPT_pie = 999,                             /* -pie */
  OPT_pipe = 1000,                           /* -pipe */
  OPT_posix = 1001,                          /* -posix */
  ...
  OPT_print_objc_runtime_info = 1007,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1008,               /* -print-prog-name= */
  OPT_print_search_dirs = 1009,              /* -print-search-dirs */
  OPT_print_sysroot = 1010,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1011,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1012,                        /* -profile */
  OPT_pthread = 1013,                        /* -pthread */
  OPT_quiet = 1014,                          /* -quiet */
  OPT_r = 1015,                              /* -r */
  OPT_rdynamic = 1016,                       /* -rdynamic */
  OPT_remap = 1017,                          /* -remap */
  OPT_s = 1018,                              /* -s */
  OPT_s_bc_abi = 1019,                       /* -s-bc-abi */
  OPT_save_temps = 1020,                     /* -save-temps */
  OPT_save_temps_ = 1021,                    /* -save-temps= */
  OPT_shared = 1022,                         /* -shared */
  OPT_shared_libgcc = 1023,                  /* -shared-libgcc */
  /* OPT_specs = 1024, */                    /* -specs */
  OPT_specs_ = 1025,                         /* -specs= */
  OPT_static = 1026,                         /* -static */
  OPT_static_libgcc = 1027,                  /* -static-libgcc */
  OPT_static_libgcj = 1028,                  /* -static-libgcj */
  OPT_static_libgfortran = 1029,             /* -static-libgfortran */
  OPT_static_libgo = 1030,                   /* -static-libgo */
  OPT_static_libstdc__ = 1031,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1032, */                /* -std=c++03 */
  OPT_std_c__0x = 1033,                      /* -std=c++0x */
  OPT_std_c__98 = 1034,                      /* -std=c++98 */
  OPT_std_c1x = 1035,                        /* -std=c1x */
  /* OPT_std_c89 = 1036, */                  /* -std=c89 */
  OPT_std_c90 = 1037,                        /* -std=c90 */
  OPT_std_c99 = 1038,                        /* -std=c99 */
  /* OPT_std_c9x = 1039, */                  /* -std=c9x */
  OPT_std_f2003 = 1040,                      /* -std=f2003 */
  OPT_std_f2008 = 1041,                      /* -std=f2008 */
  OPT_std_f95 = 1042,                        /* -std=f95 */
  OPT_std_gnu = 1043,                        /* -std=gnu */
  OPT_std_gnu__0x = 1044,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1045,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1046,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1047, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1048,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1049,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1050, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1051, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1052,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1053, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1054, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1055,                     /* -std=legacy */
  OPT_symbolic = 1056,                       /* -symbolic */
  OPT_t = 1057,                              /* -t */
  OPT_time = 1058,                           /* -time */
  OPT_time_ = 1059,                          /* -time= */
  OPT_tno_android_cc = 1060,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1061,                 /* -tno-android-ld */
  OPT_traditional = 1062,                    /* -traditional */
  OPT_traditional_cpp = 1063,                /* -traditional-cpp */
  OPT_trigraphs = 1064,                      /* -trigraphs */
  OPT_u = 1065,                              /* -u */
  OPT_undef = 1066,                          /* -undef */
  OPT_v = 1067,                              /* -v */
  OPT_version = 1068,                        /* -version */
  OPT_w = 1069,                              /* -w */
  OPT_wrapper = 1070,                        /* -wrapper */
  OPT_x = 1071,                              /* -x */
  OPT_z = 1072,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
